...
allowing somebody to distribute a Bitcoin-Qt.app or hydracoin-qt-setup.exe with a valid
...
that the hydracoin-qt.exe file inside the installer had not been tampered with.
