...
environ_default("CLONE_URL", "https://github.com/hydracoin/hydracoin.git")
...
environ_default("BUILD_PATH", "/mnt/hydracoin")
...
environ_default("GITHUB_REPO", "hydracoin/hydracoin")
